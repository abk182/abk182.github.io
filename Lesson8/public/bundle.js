...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__classes_user_js__ = __webpack_require__(2);
...
function renderList(){
__WEBPACK_IMPORTED_MODULE_1_superagent___default.a
	.get('/list')
	.end((err,res)=>{
		document.getElementById('user-list').innerHTML = '';
		res.body.forEach((item,index) =>{
			new __WEBPACK_IMPORTED_MODULE_0__classes_user_js__["b" /* User */](item).renderUser(item.id);
		});
		new __WEBPACK_IMPORTED_MODULE_0__classes_user_js__["a" /* Admin */]().walkLikeAdmin();
...
__WEBPACK_IMPORTED_MODULE_2_jquery___default.a('#add').on('click', function(){
let data = {
	id: new Date(),
	name: __WEBPACK_IMPORTED_MODULE_2_jquery___default.a('#name').val(),
	age: __WEBPACK_IMPORTED_MODULE_2_jquery___default.a('#age').val()
}
__WEBPACK_IMPORTED_MODULE_1_superagent___default.a
	.post('/add_user')
	.send(data)
